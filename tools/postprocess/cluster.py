...
def _morphological_process(image, mode='MORPH_CLOSE', kernel_size=5):
    """
    ...
    if mode == 'MORPH_CLOSE':
        ...
        closing = cv2.morphologyEx(image, cv2.MORPH_OPEN, kernel, iterations=1)
    else:
        closing = image
    return closing
...
class LaneNetPostProcessor(object):
    ...
    def postprocess(self, binary_seg_result, mode, instance_seg_result=None, min_area_threshold=100):
        """
        ...
        morphological_ret = _morphological_process(binary_seg_result, mode, kernel_size=5)
