...
from data_osm.dataset import PMapNetDataset
from data_osm.rasterize import rasterize_map
from data_osm.const import NUM_CLASSES
from nuscenes.utils.splits import create_splits_scenes


class PMapNetEvalDataset(PMapNetDataset):
    def __init__(self, version, dataroot, eval_set, result_path, data_conf, max_line_count=300):
        self.eval_set = eval_set
        super(PMapNetEvalDataset, self).__init__(version, dataroot, data_conf, is_train=False)
    ...
    def __getitem__(self, idx):
        ...
        gt_vectors, polygon_geom, osm_vectors = self.vector_map.gen_vectorized_samples(location, ego_pose['translation'], ego_pose['rotation'])
